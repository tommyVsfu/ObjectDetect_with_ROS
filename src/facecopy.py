...
class face_detector_wama(object):
	def __init__(self):
		...
		self.pub_car_cmd = rospy.Publisher("car",Twist2DStamped,queue_size=1)
		...
		self.sub_image_origin = rospy.Subscriber("rawimage", CompressedImage, self.cbImage, queue_size=1)
